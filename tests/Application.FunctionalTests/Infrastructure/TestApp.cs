...
namespace CafePosBackend.Application.FunctionalTests.Infrastructure;
...
public static class TestApp
{
    ...
    public static async Task<Guid> RunAsUserAsync(string userName, string password, string[] roles)
    {
        ...
        var user = new ApplicationUser { UserName = userName, Email = userName, PhoneNumber = "09123456789" };

using CafePosBackend.Domain.Events;
using Microsoft.Extensions.Logging;

namespace CafePosBackend.Application.TodoItems.EventHandlers;
...
public class LogTodoItemCompleted : INotificationHandler<TodoItemCompletedEvent>
{
    ...
    {
        _logger.LogInformation("CafePosBackend Domain Event: {DomainEvent}", notification.GetType().Name);
